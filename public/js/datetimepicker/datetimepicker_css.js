...
var SpanBgColor = "#888888"; //span background color
var MonthYearColor = "#cc0033"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#18861B"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#80B60F"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#80B60F"; //Background color of Saturday.
...
var imageFilesPath = "/MySpaceEmpire/js/datetimepicker/images/";
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime += "<tr><td colspan='8' style=\"text-align:center;\"><input style='width:60px;font-size:12px;' onClick='document.getElementById(\"" + Cal.Ctrl + "\").value = \"\"; winCal.style.visibility = \"hidden\"'  type=\"button\" value=\"Clear\">&nbsp;<input style='width:60px;font-size:12px;' onClick='javascript:closewin(\"" + Cal.Ctrl + "\");'  type=\"button\" value=\"OK\">&nbsp;<input style='width:60px;font-size:12px;' onClick='javascript: winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Cancel\"></td></tr>";
	}
	...
	if (!winCal)
	{
		...
		cssStr = ".calTD {font-family: verdana; font-size: 12px; text-align: center; border:0; color:" + FontColor + ";}\n";
